        ...
        # the options for each category
         ...
         for category, meals in menu.items():
            for meal, price in meals.items():
                ...
                print_menu_line(index, category, meal, price)
                index += 1
...
def update_order(order, menu_selection, menu_items):
    ...
    try:
        ...
        print("Invalid menu number. Please enter a number.")
        return order
    ...
    if menu_selection not in menu_items:
        print("Menu item not found. Please select a valid menu number.")
        return order
    ...
    item_info = menu_items[menu_selection]
